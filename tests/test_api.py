...
from custom_components.mg_ismart_india.api.crypto import normalize_phone, hash_control_pin, gateway_signature, tap_signature
from custom_components.mg_ismart_india.api.client import parse_status, discover_capabilities
from custom_components.mg_ismart_india.api.tap import encode_status_request, encode_control_request, encode_pin_request
...
def test_status_parser():
    s = parse_status({'statusTime': 1,
                      'basicVehicleStatus': {'lockStatus': True,
                                             'driverDoor': False,
                                             'fuelLevelPrc': 50,
                                             'fuelRange': 123,
                                             'mileage': 456,
...
def test_capabilities_and_encoders():
    c = discover_capabilities([{'configuration': {'S61': '1',
                                                  'T11': '1',
                                                  'WINDOW': '1111',
                                                  'BOOT': '1',
                                                  'S35': '1',
